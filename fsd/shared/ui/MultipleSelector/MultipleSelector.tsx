...
export interface IMultipleSelectorOption {
  value: string;
  label: string;
  disable?: boolean;
...
interface GroupOption {
  [key: string]: IMultipleSelectorOption[];
}

interface MultipleSelectorProps {
  value?: IMultipleSelectorOption[];
  options?: IMultipleSelectorOption[];
  placeholder?: string;
  /** Loading component. */
  ...
  delay?: number;
  /** async search */
  onSearch?: (value: string) => Promise<IMultipleSelectorOption[]>;
  onChange?: (options: IMultipleSelectorOption[]) => void;
...
export interface MultipleSelectorRef {
  selectedValue: IMultipleSelectorOption[];
...
function removePickedOption(
  ...
  picked: IMultipleSelectorOption[],
) {
...
>(
  (
    ...
    const handleUnselect = React.useCallback(
      (option: IMultipleSelectorOption) => {
